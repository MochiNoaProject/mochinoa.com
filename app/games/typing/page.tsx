...
export default function TypingGame() {
  ...
  // ローマ字の異体字マッピング
  const romajiVariants: { [key: string]: string[] } = {
    "fu": ["hu"],
    "ji": ["zi"],
    "zu": ["du"],
    "cha": ["tya"],
  ...
  const words = [
    "うさぎ", "ねこ", "いぬ", "ぱんだ", "ひよこ",
    "くまさん", "はむすたー", "ことり", "りすさん", "あひる",
    "まんまる", "ふわふわ", "もふもふ", "ぷにぷに", "にこにこ",
    "わんわん", "にゃんこ", "ぴよぴよ", "うさちゃん", "こねこ",
    "おやつ", "けーき", "ぷりん", "あめちゃん", "くっきー",
    "わたあめ", "どーなつ", "ちょこれーと", "きゃんでぃ", "まかろん",
    "はーと", "らぶらぶ", "にっこり", "すまいる", "きらきら",
    "ゆめかわ", "めろめろ", "ぱきゅぱきゅ", "ほわほわ", "ぽかぽか"
  ];
  ...
  const handleInput = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const isValidRomaji = possiblePatterns.some(pattern => pattern.startsWith(value));
    if (isValidRomaji) {
      setInput(value);
